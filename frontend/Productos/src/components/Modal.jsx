...
const FormValidations = {
  ...
  precio: [( value ) => value > 0, 'La descripcion es obligatorio'],
  cantidad: [( value ) => value > 0, 'La cantidad es obligatorio'],
...
export const Modal = ({ openModal, handleClose, producto2, getProducts }) => {
  ...
  const { nombre, descripcion, precio, cantidad, img, categoria , nombreValid, 
    descripcionValid, precioValid, cantidadValid, imgValid, categoriaValid, onInputChange, formState:FormProduct,
      ...
      <Dialog open={openModal} onClose={onCLose}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            value={cantidad} 
            name="cantidad" 
            error={!!cantidadValid && FormSubmitted} 
            helperText={cantidadValid} 
            onChange={onInputChange} 
          />
           <TextField
            autoFocus
